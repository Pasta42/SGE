...
include_once "../class/produtos.class.php";
	...
	$obj = new Produtos;
	 	...
	 	if(isset($_POST['buscar']) AND $_POST['buscar'] != ""){
			$buscar = strip_tags($_POST['buscar']);
			$retorno = $obj->listar(' WHERE nome like "%'.$buscar.'%" LIMIT 50');
		}else{
			$retorno ='';
		}
		if($retorno ==''){
			echo "
					<tr>
						<td colspan='8'>
							Sua busca não retornou nenhum resultado, tente novamente ou clique <a href='listarproduto.php'> aqui </a> para ver os últimos produtos adicionados.
						</td>
					</tr>";
		}else {
